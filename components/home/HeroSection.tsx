            ...
            <div className="absolute z-10 w-full h-full flex justify-center items-center  text-white bg-black/50">
                <div className="text-center space-y-4 md:space-y-8">
                    <div className="flex flex-col items-center space-y-3 md:space-y-6">
                        <h1 className="max-w-md md:max-w-2xl text-[clamp(16px,6vw,40px)] text-amber-400 font-bold italic">Don&apos;t wish for a good body, work for it.</h1>
                        <h2 className="max-w-xs text-md text-center text-gray-200  italic">At union aesthetic we help you to acheieve the shape that you always dreamed of.</h2>
                    </div>
